...
public:
     ...
     */
	JudgerInfo(string _oj, string _id, string _username, string _password,
		   int _max_wait_time):oj(_oj), id(_id), username(_username),
	    password(_password), max_wait_time(_max_wait_time) {
	} virtual ~ JudgerInfo();
