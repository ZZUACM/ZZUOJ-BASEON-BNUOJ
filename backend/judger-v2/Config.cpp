...
Config::Config()
{
	try {
		...
		low_privilege_uid =
		    atoi(ini.top()["low_privilege_uid"].c_str());
		general_compile_time =
		    atoi(ini.top()["general_compile_time"].c_str());
//        generator_run_time = atoi(ini.top()["generator_run_time"].c_str());
		generator_run_memory =
		    atoi(ini.top()["generator_run_memory"].c_str());
		vmlang_multiplier =
		    atoi(ini.top()["vmlang_multiplier"].c_str());
		...
		checker_run_memory =
		    atoi(ini.top()["checker_run_memory"].c_str());
