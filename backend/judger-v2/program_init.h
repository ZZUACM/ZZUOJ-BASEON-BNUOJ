...
void init_error()
{
	syscalls_other[SYS__sysctl] = true;	/*syscalls_other[SYS_access]=true; */
	syscalls_other[SYS_chdir] = true;
	...
	syscalls_csharp[SYS__sysctl] = true;	/*syscalls_csharp[SYS_access]=true; */
	syscalls_csharp[SYS_chdir] = true;
	syscalls_csharp[SYS_chmod] = true;
	syscalls_csharp[SYS_chown] = true;
	syscalls_csharp[SYS_chroot] = true;	/*syscalls_csharp[SYS_clone]=true;syscalls_csharp[SYS_close]=true; */
	...
	/*syscalls_csharp[SYS_mkdir]=true; */ syscalls_csharp[SYS_mknod] = true;
	...
	syscalls_csharp[SYS_bind] = true;	/*syscalls_csharp[SYS_connect]=true; */
	syscalls_csharp[SYS_listen] = true;
...
void init_others()
{
	vmlang[JAVALANG] = vmlang[PYLANG] = vmlang[PERLLANG] =
	    vmlang[RUBYLANG] = true;
